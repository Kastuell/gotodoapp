...
func (r *TodoItemPostgres) Create(listId int, item todo.TodoItem) (todo.TodoItem, error) {
	tx, err := r.db.Begin()
...
func (r *TodoItemPostgres) GetAllByUserId(userId, listId int) ([]todo.TodoItem, error) {
